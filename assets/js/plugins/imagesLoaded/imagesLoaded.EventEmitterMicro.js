(function(app, $, $dom, EV, _){
    ...
    app.define("plugins.imagesLoaded.EventEmitterMicro");

    app.plugins.imagesLoaded.EventEmitterMicro = function(){
        this._events = {};
    };

    app.plugins.imagesLoaded.EventEmitterMicro.prototype = {
        on: function(g, h) {
