(function(app, $, $dom, EV, _){
    ...
    app.define("plugins.scroll.clip");

    var q = app.plugins.easing.createPredefined;
    var E = app.plugins.scroll.clock;
    var s = app.plugins.easing.Ease;
