...
// MY_FIX //
  var update = dom.getAttribute("onupdate"),
  	  el;
  ...
  if (!e.preventUpdate && update !== "none") {
	if (update === "self"){
	  ...
	  el = this.__.parent ? this.__.parent : this
	}
	else {
	  el = getImmediateCustomParentTag(this);
	}
	// fixes #2083
	if (el.isMounted) { el.update(); }
  }
