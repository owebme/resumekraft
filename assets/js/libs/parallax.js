! function(t, i, e, s) {
    ...
    o.prototype.transformSupport = function(t) {
        for (var o = e.createElement("div"), n = !1, r = null, a = !1, h = null, l = null, p = 0, c = this.vendors.length; p < c; p++)
            ...
            case "3D":
                if (n) {
                    var y = e.body || e.createElement("body"),
                        u = e.documentElement,
                        m = u.style.overflow;
                    e.body || (u.style.overflow = "hidden", u.appendChild(y), y.style.overflow = "hidden", y.style.background = ""), y.appendChild(o), o.style[l] = "translate3d(1px,1px,1px)", r = i.getComputedStyle(o).getPropertyValue(h), a = r !== s && r.length > 0 && "none" !== r, u.style.overflow = m, y.removeChild(o)
                }
        }
        return a
        ...
        if (!n)
            for (var r = 0, a = this.vendors.length; r < a; r++)
                if (n = null !== this.vendors[r] ? t.camelCase(this.vendors[r][1] + "-" + e) : e, i.style[n] !== s) {
    ...
    t.fn[n] = function(i) {
        ...
        return this.each(function() {
            var s = t(this),
                r = s.data(n);
            r || (r = new o(this, i), s.data(n, r)), h[i] && r[i].apply(r, Array.prototype.slice.call(e, 1))
        })
    }
