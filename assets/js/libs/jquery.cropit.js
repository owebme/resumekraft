	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function shouldRejectImage(_ref) {
		 ...
		 if (imageWidth >= previewSize.width){
			 if (previewSize.height > imageHeight){
				...
				if (this.options.maxHeight){
					previewSize.height = this.options.maxHeight;
					this.previewSize = {
					   width: previewSize.width,
			 ...
			 if (this.options.onSmallImage && typeof this.options.onSmallImage == "function"){
				 this.options.onSmallImage({
					 width: imageWidth,
					 height: imageHeight
				 })
			 }
	    ...
	    value: function getCroppedImageData(exportOptions) {
	      ...
	      var exportZoom = exportOptions.originalSize ? (exportOptions.maxZoom && 1 / this.zoom > exportOptions.maxZoom ? exportOptions.maxZoom : 1 / this.zoom) : this.options.exportZoom;
