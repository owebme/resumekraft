    ...
    <div class="oScreen__jqtest__enter__phone__left">
        <div class="anim-group1 anim-fadeIn" data-duration="xs">
            <div class="overview__phone" data-color="white" data-align="left">
                <div style="background-image:url('/public/images/promo/jqtest/slide2_1_screen.jpg')" class="overview__phone__screen bg-cover"></div>
            </div>
        </div>
    </div>
    ...
    <div class="oScreen__jqtest__enter__text overview__section container pt70 pb-l">
        <div class="row">
            <div class="col-md-offset-4 col-md-16">
                <small class="mb-l anim-group2 anim-scale-zoom anim-delay-s">Совершенно бесплатно</small>
                ...
                <div class="anim-group2 anim-scale anim-delay-xl">
                    <button onClick={ parent.open.test } onUpdate="none" class="btn btn-xl2 btn-primary">Пройти JQ-тест</button>
                </div>
            </div>
        </div>
