        ...
        <div class="oScreen__jptest__enter__text__inner overview__section container">
            <div class="row">
                <div class="centered col-md-16">
                    ...
                    <p class="mb50 fontSize-24 lineHeight-xxxl c-gray anim-group2 anim-bt anim-delay-l">{ passed ? 'Можно вернуться к резюме.' : 'Узнайте немного больше после, чем вы знали до.' }</p>
