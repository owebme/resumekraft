<overview-premium-content class="overview-premium">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-18 col-lg-16 centered">
                    ...
                    <div class="ptb-l">
                        <icon-control size="xl" color="primary"></icon-control>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-19 col-lg-16 centered">
                    ...
                    <div class="ptb-l">
                        <icon-glass size="xl" color="primary"></icon-glass>
                    </div>
                    <h1 class="mb-l pt-m">Качественный дизайн адаптированный под все современные устройства.</h1>
                    <p class="pb-l">Использование новейших web-технологий позволило создать резюме одинаково прекрасное и для редактирования и для просмотра на абсолютно всех устройствах: декстопах, на смартфонах и планшетах. Мы добились отличной совместимости с мобильными устройствами, сделав 100% адаптацию. Результат — стильное и информативное резюме, что приятно удивит ваших работодателей.</p>
                </div>
                <div class="col-md-24">
    ...
    <section class="overview__section" data-bg="gradient-tb">
        <div class="container pt-xl">
            <div class="row pt-l">
                <div class="col-md-18 col-lg-16 centered">
                    <p>Немаловажно, что и создание и управление резюме доступно на всех мобильных платформах, а не только на декстопе, и вам даже не потребуется устанавливать никаких приложений, просто заходите на web-сервис и пользуйтесь.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-18 col-lg-16 centered">
                    ...
                    <p class="pb-l">При оформлении резюме, вы сможете подобрать именно ту палитру, которая будет лучшим образом отвечать характеру вашей карьерной позиции. Были отобраны наиболее стильные цвета, и у вас будет из чего выбрать в несколько кликов.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container pt-xl">
            ...
            <div class="row mt-xl">
                ...
                <div class="col-md-11 col-lg-10 text-left pt-xl pr-xl sm-plr0 sm-pt-l">
                    <h2 class="mt-xl sm-mt0 md-mt-m">В вашем кармане, доступно в облаке.</h2>
                    <p class="pt-m">Теперь это легко и доступно в вашем кармане, без установки приложений. Мобильное web-приложение находится в облаке, это быстро и современно.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container pt30 pb-l sm-pt-xl">
            <div class="row pt-l">
                <div class="col-md-10 sm-plr0 text-left zIndex-1">
                    ...
                    <h1 class="mb-l pt-l pr-l md-pr0">Выбирайте свой девайс для работы.</h1>
        ...
        <div class="container pt-l">
            <div class="row pt-m">
                ...
                <div class="col-md-9 col-lg-8 pl0 pt-xl sm-plr0 sm-pt-l md-pl-m text-left zIndex-1">
                    ...
                    <p class="pb-l sm-pb-xl">Как уже было упомянуто, просмотр и редактирование доступно на мобильных устройствах. Вы можете начать создание резюме на планшете, а позже продолжить в смартфоне, и закончить на десктопе.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="overview__section text-left mb0">
        <div class="container">
            <div class="row mb-l">
                <div class="col-md-12 sm-pb-m sm-pt-m">
                    <div class="pr-xl md-pr-m sm-mt-xl sm-mb-l">
                        ...
                        <h2>На любом современном мобильном устройстве.</h2>
                    </div>
                </div>
                <div class="col-md-12">
                        ...
                        <div class="overview__phone__screen">
                            ...
                            <div class="screens screens-tablet screens-desktop" data-vertical="true" data-round="true" data-autorun="true">
                                <div each={ item, i in opts.utils.range(12) } no-reorder class="screen { screen--active : i == 0 }">
                                    <div class="screen__content pos-abs-full bg-cover progressive-image" style="background-image:url(/public/images/promo/premium/mobile_resume_screen{ item + 1 }{ i == 0 ? '.jpg' : '.png' })"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mb-m slide-video">
                <div class="col-md-12 anim anim-scale-soft">
                    <div class="overview__phone" data-align="left" data-color="white">
                        <div class="overview__phone__screen bg-cover progressive-image" style="background-image:url(/public/images/premium/samples/overview/phone_screen_woman2_large_2x.jpg)">
                            <div class="overview__phone__nav bg-cover"></div>
                    ...
                    <div class="overview__phone" data-align="left" data-color="white">
                        <div class="overview__phone__screen">
                            <div class="screens screens-tablet screens-desktop" data-vertical="false" data-autorun="true">
                                ...
                                <div class="screen">
                                    <div class="screen__content pos-abs-full bg-cover progressive-image" style="background-image:url(/public/images/promo/premium/mobile_salary_screen2.jpg)">
    ...
    <section class="overview__section" data-section="clouds">
        <div class="ovpremium__clouds">
            <small class="ovpremium__clouds__title">Смотрите примеры резюме</small>
            <div class="ovpremium__clouds__list">
                <div class="ovpremium__clouds__item ovpremium__clouds__layer ovpremium__clouds__layer_top">
                    <div class="layer bg-cover progressive-image" data-depth="0.02"></div>
                </div>
                <div class="ovpremium__clouds__item ovpremium__clouds__layer ovpremium__clouds__layer_center">
                    <div class="layer bg-cover progressive-image" data-depth="0.05"></div>
                </div>
                <div class="ovpremium__clouds__item ovpremium__clouds__layer ovpremium__clouds__layer_bottom">
                    <div class="layer bg-cover progressive-image" data-depth="0.1"></div>
                </div>
                <div class="ovpremium__prof__items">
                    ...
                    <script>
                        ...
                        this.getPhoto = function(){
                            var photo = $.opts.utils.random(1, 42);
            ...
            <div class="ovpremium__clouds__fly">
    ...
    <section class="overview__section mb0" data-section="finish">
        ...
        <div class="pos-rel nowrap" style="height:555px">
            <div class="pos-tl w50p h100p bg-steel">
