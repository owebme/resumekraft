<overview-premium-content class="overview-premium">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-16 centered">
                    ...
                    <p class="pb-l" data-scrollin>Взаимодействие с интерфейсом работает так, чтобы вам было удобно. Зачем что-то объяснять когда все работает интуитивно понятно для вас. Вы легко освоитесь в интерфейсе, быстро и просто создав лучшее резюме. После нескольких минут вы получите, то резюме, которое всегда хотели.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-16 centered">
                    ...
                    <p class="pb-l" data-scrollin>Использование новейших web-технологий позволило создать резюме одинаково прекрасное и для редактирования и для просмотра на всех устройствах. Мы добились отличной совместимости с мобильными устройствами, сделав 100% адаптацию. Результат — стильное и информативное резюме с отличной мобильной совместимостью, что приятно удивит ваших работодателей.</p>
                </div>
                <div class="col-md-24">
    ...
    <section class="overview__section" data-bg="gradient-tb">
        <div class="container pt-xl">
            <div class="row pt-l">
                <div class="col-md-16 centered" data-scrollin>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-16 centered">
                    ...
                    <p class="pb-l" data-scrollin>Вы сможете выбрать и подобрать именно ту палитру, которая будет лучшим образом отвечать характеру вашей карьерной позиции. Были отобраны наиболее стильные цвета, у вас будет из чего выбирать в несколько кликов.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container pt-xl pb-l">
            <div class="row pt-l">
                <div class="col-md-10 text-left zIndex-1">
                    ...
                    <p class="pb-xl" data-scrollin>Понимайте эффективность ваших резюме. Будьте в курсе сколько и когда просмотрели ваши резюме, теперь это легко и доступно в вашем кармане. Вы можете создать несколько резюме и сравнить их эффективность опираясь на доступные показатели посетителей и просмотров.</p>
                    <div class="chart__radial anim anim-scale-soft" name="chartRadialEl"  data-delta="xs"></div>
                    <small class="pos-bl w100p" style="transform:translate3d(280px, 175px, 0); line-height:38px;"><span data-scrollin>У вас есть возможность создать продающее резюме и сделать его еще эффективней, используя доступный функционал.</span></small>
                </div>
        ...
        <div class="container pt-l">
            <div class="row pt-l">
                ...
                <div class="col-md-10 pl0 text-left zIndex-1">
                    ...
                    <p class="pb-l" data-scrollin>Планируите устроиться в зарубежную компанию. Отлично, резюме доступно и на английском языке. Весь интерфейс переведен, оставляя возможность гибко внести свои изменения в дизайн. Также указать заработную плату в иностранной валюте, в долларах или евро.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container pt-l">
            <div class="row pt-m">
                ...
                <div class="col-md-8 pl0 pt-xl text-left zIndex-1">
                    ...
                    <p class="pb-l" data-scrollin>Как уже было упомянуто, просмотр и редактирование доступно на мобильных устройсвах. Вы можете начать создание резюме на планшете, а позже продолжить в смартфоне, и закончить на десктопе.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row mb-l">
                ...
                <div class="col-md-12">
                    ...
                    <p class="pt-m" data-scrollin>Этому моменту мы уделили особое внимание, чтобы просмотр и редактирование ваших резюме, с использованием мобильных устройств, были максимально удобными и комфортными.</p>
                </div>
            </div>
            <div class="row pt-m">
                ...
                <div class="col-md-12 pt-xl pr-xl">
                    ...
                    <p class="pt-m" data-scrollin>Вам даже не потребуется устанавливать никаких приложений, просто заходите в свой аккаунт и пользуйтесь. Вы можете добавить иконку на главный экран смартфона для быстрого доступа к сервису.</p>
            ...
            <div class="row">
                <div class="col-md-12 pt-xl pl-xl pr-l">
                    ...
                    <p class="pt-m" data-scrollin>Посмотрите как органично резюме на экране смартфона. Выглядит очень свежо и современно. У вас будет возможности протестировать резюме на разных платформах.</p>

                    <div class="w80 h2px bg-blue mtb-xl"></div>

                    <h3 class="mb-xs">Перенести резюме</h3>
                    <p class="mb-m" data-scrollin>Если у вас есть резюме на хантинговом сервисе HeadHunter, вы можете его перенести мгновенно в один клик, указав одну ссылку.</p>
                </div>
                <div class="col-md-12 anim anim-scale-soft">
            ...
            <div class="row">
                ...
                <div class="col-md-12 pt-xl pr-xl">
                    ...
                    <p class="pt-m" data-scrollin>Получайте приглашения и отклики от ваших потенциальных работадателей.</p>

                    <div class="w80 h2px bg-blue mtb-xl"></div>

                    <h3 class="mb-xs">Менеджер входящих</h3>
                    <p data-scrollin>Каждое занятие заслуживает своего саундтрека. Готовьте ужин, бегайте, танцуйте, занимайтесь спортом или отдыхайте под музыку, подобранную специально для этого.</p>
            ...
            <div class="row pt-l pb-xl">
                <div class="col-md-12 pt-xl pl-xl pr-l">
                    <div class="pos-rel pt-m zIndex-1">
                        ...
                        <p class="pt-m" data-scrollin>Есть собственные проекты? Расскажите о них, прикрепив фото и видео материалы</p>

                        <div class="w80 h2px bg-blue mtb-xl"></div>

                        <h3 class="mb-xs">Микс из новой музыки</h3>
                        <p class="mb-m" data-scrollin>Мало найти новую музыку. Главное, чтобы она вам понравилась. Каждую пятницу наши кураторы составляют плейлист из новых композиций — приятный сюрприз к выходным.</p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 pt-xl pr-xl">
                    ...
                    <p class="pt-m" data-scrollin>Большинству работодателей интересно знать о ваших увлечениях и видеть список ваших хобби в резюме.</p>
            ...
            <div class="row mb-m">
                ...
                <div class="col-md-12 pt-xl pr-xl">
                    ...
                    <p class="pt-m" data-scrollin>Выстраивайте желаемый график заработной платы на ближайшие 2 года. Любому работодателю будут интересны ваши абции по данному вопросу.</p>
        ...
        <div class="container">
            <div class="row pl-xl">
                <div class="col-md-12 pt55 pr-m zIndex-1">
                    ...
                    <p data-scrollin>Премиальное резюме позволит найти работу вашей мечты. Совершенно по-новому позволит обратить внимание на вашу кандидатуру. Яркое резюме поможет быстрее найти работу вашей мечты.</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-16 centered anim anim-scale-soft" data-delta="s">
                    ...
                    <p data-scrollin>Вы можете выбрать ежемесячную подписку или на год с приличной скидкой.</p>
                </div>
            </div>
