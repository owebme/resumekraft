<vacancy-panel class="section vacancy__panel container">
    ...
    <div class="row">
        <div class="col-md-offset-8 col-md-15 col-lg-offset-12 col-lg-12">
            <div class="vacancy__panel__block">
                <a target="_blank" href="https://hh.ru/applicant/vacancy_response?vacancyId={ opts.item.id }" class="vacancy__panel__button btn btn-primary-hover-success btn-shadow btn-l">
                ...
                <vacancy-panel-btn-favorite></vacancy-panel-btn-favorite>
