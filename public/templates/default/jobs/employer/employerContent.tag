<employer-content class="section col-md-19">

    <div class="section__container">
        <!-- <employer-type type={ opts.item.type }></employer-type> -->
        <div class="row">
            <div class="col-md-6">
                <div class="employer__sidebar">
                    <img if={ opts.item.logo_urls } src="{ opts.item.logo_urls.original }" class="display-block w90p centered">
                    <div class="mt-m mb-l">
                    ...
                    <div class="mb-l">
                        ...
                        <a href="#vacancies" if={ opts.items.length } class="link">{ opts.items.length } активных вакансий</a>
