                    ...
                    <div class="phone__wrapper">
                        <div class="phone__screen">
                            ...
                            <div class="screens screens-tablet screens-desktop">
                                <div each={ item, i in opts.utils.range(40) } no-reorder class="screen { screen--active : i == 0 } bg-cover" style="background-image:url(/public/images/samples/{ item + 1 }.jpg)">
                            ...
                            <a href="/premium/samples" class="opener"></a>
                        </div>
                    </div>
                </div>
            </div>
