    ...
    <div class="container">
        <div class="row">
            <div class="home__header__text col-sm-24 col-md-24 col-lg-20 centered rellax" data-rellax-speed="-2.25">
                <h1 class="home__header__title anim-group1 anim-scale-soft">Создайте <span class="c-lime">крутое резюме</span> и <span class="c-lime">получите</span> престижную <span class="c-lime">работу.</span></h1>
