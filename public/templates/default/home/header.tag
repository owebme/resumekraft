    ...
    <div class="container">
        <div class="row">
            <div class="home__header__text col-sm-24 col-md-24 col-lg-20 centered rellax" data-rellax-speed="-2.25">
                ...
                <div if={ !parent.opts.device.phone() } class="home__header__subtitle plr-xl mlr-l sm-mlr0 anim-group1 anim-bt" data-delay="s">По-настоящему уникальная возможность создать классное резюме самому за несколько минут.</div>
                <div class="inline">
