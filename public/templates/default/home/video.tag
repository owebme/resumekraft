    ...
    <div class="container">
        <div class="row text-center mb55">
            <div class="col-md-16 centered">
                ...
                <p class="c-gray text">Еще никогда резюме не было настолько современным. Существенно увеличить шансы прохождения собеседования поможет видео обращение, ваше резюме станет по-настоящему ценным и интересным патенциальному работодателю.</p>
            </div>
        </div>
        <div class="row">
