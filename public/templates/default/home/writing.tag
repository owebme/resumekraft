<section-writing class="content__section">
        ...
        <div class="row">
            <div class="col-md-24">
                <div class="content__block">
                    ...
                    <h1 class="mb-m c-primary">Хотите заказать резюме?</h1>
                    <p class="c-gray text mb50">Выберите подходящий вариант.</p>

                    <div class="plans">
                        <div class="plan">
                            <div class="row plan__item">
                                <div class="col-md-12 plan__title">Резюме под ключ</div>
                        ...
                        <div class="plan">
                            <div class="row plan__item">
                                <div class="col-md-12 plan__title">Срочное резюме</div>
                                <div class="col-md-6 plan__buttons">
                                    <div class="btn btn-open btn-s btn-primary-hover">Подробнее</div>
                                </div>
