        ...
        <div class="row">
            ...
            <div class="nav__cell col-xs-24 col-sm-12 col-md-14 col-lg-17">
                <div class="nav__menu">
                    ...
                    <a href="/jp-test/" class="nav__menu__item hidden-sm hidden-md" data-active="{ opts.section == 'jp-test' }">JP-тест 2.0</a>
            ...
            <div class="nav__buttons nav__cell col-xs-16 col-sm-8 col-md-6 col-lg-4">
                ...
                <div class="fontSize-0 nowrap pos-rel pl-m ml-xxs float-left xs-p0 xs-m0">
                    ...
                    <a href="/private/" if={ opts.user } class="nav__button btn btn-m btn-upper btn-strong btn-white-hover">Мои резюме</a>
                </div>
            </div>
        </div>
