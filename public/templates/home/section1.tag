<home-section1 class="home__section1 rows screen pos-rel rellax zIndex-1" data-rellax-speed="6.5">
    ...
    <div class="screen__content home__section1__container flex-row-center-stretch row">
        ...
        <div class="col-xs-24 col-md-14 col-lg-12 overflow-hidden text-center">
            <div class="pos-abs-full bg-cover" style="background-image:url(http://melinda.themes.tvda.eu/wp-content/uploads/2016/04/man-phone.jpg)"></div>
            <div class="pos-abs-full bg-overlay opacity-95"></div>
            <div class="rellax anim anim-scale-soft" data-rellax-speed="2.7">
                <img class="home__section1__image" src="/assets/images/home/phone_black.png">
            </div>
        </div>
    </div>
