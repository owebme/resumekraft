            ...
            <div class="pos-centered">
                <div class="rellax anim anim-scale" data-rellax-speed="3.5">
                    <div class="home__jqtest__container">
                        <small class="c-white mb-l pb-m sm-pb-l">ещё вкусное</small>
                        <h1 class="c-white nowrap textShadow-light mb-m pb-xs">Пройти новейший <span class="c-lime">JQ<sup>2</sup></span> тест</h1>
