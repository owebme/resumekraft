<home-section2 class="home__section2 rows screen pos-rel rellax zIndex-1" data-rellax-speed="7.25">
    ...
    <div class="home__section2__container flex-row-center-stretch row">
        <div class="hidden-sm col-sm-24 col-md-10 col-lg-12 bg-white overflow-hidden text-center">
            <div class="rellax anim anim-lr-soft" data-rellax-speed="2.7">
                <img class="home__section2__image" src="http://images.apple.com/ru/ios/what-is/images/easytouse_large_2x.jpg">
            </div>
        </div>
